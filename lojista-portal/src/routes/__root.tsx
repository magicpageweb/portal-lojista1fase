...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@sindilojas" },
      { name: "twitter:title", content: "Portal do Lojista | Sindilojas" },
      { name: "twitter:description", content: "Sindilojas Conecta Lojista - Portal oficial do sindicato dos lojistas para divulgar comércios, produtos e serviços locais." },
    ],
    links: [
      {
        rel: "stylesheet",
